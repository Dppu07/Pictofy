      ...
      <div>
        {user ? (
          <div className='flex items-center gap-2 sm:gap-3'>
            <button className='flex items-center gap-2 bg-blue-100 px-4 sm:px-5 py-1.5 sm:py-2 rounded-full hover:scale-105 transition-all duration-700'>
            ...
            <div className = 'relative group'>
              <img src = {assets.profile_icon} alt = "logout" className = "w-10 drop-shadow" />
